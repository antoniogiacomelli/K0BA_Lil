...
/*
 * Typedef for kernel objects
 *
 * Any type in K0BA with the suffix _HANDLE is a pointer
 * to an object or data structure. It is never an integer, index, or other opaque type.
 *
 **/
